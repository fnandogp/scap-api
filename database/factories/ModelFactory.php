...
$factory->define(\App\RemovalRequest::class, function (Faker\Generator $faker) {
    return [
        ...
        'removal_from'        => $faker->dateTimeBetween('+1 day', '+10 days')->format('Y-m-d'),
        'removal_to'          => $faker->dateTimeBetween('+30 days', '+100 days')->format('Y-m-d'),
        'removal_reason'      => $faker->paragraph,
        'onus'                => array_random(\App\Enums\RemovalRequestOnus::keys()),
        'event'               => $faker->sentence,
        'city'                => $faker->city,
        'event_from'          => $faker->dateTimeBetween('+10 days', '+15 days')->format('Y-m-d'),
        'event_to'            => $faker->dateTimeBetween('+16 days', '+25 days')->format('Y-m-d'),
